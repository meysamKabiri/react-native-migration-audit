...
- React Native: 0.83.6; React: 19.2.0; TypeScript: 5.9.2.
...
- 5 risky dependency package(s) were detected.
...
- ARCocoaConstants: ios (high)
- ARNotifications: ios (high)
- ARPHPhotoPicker: ios (high)
- ARScrollViewHelpers: ios (high)
- ARTArtsyNative: ios (high)
- ARTDeeplinkTimeout: ios (high)
- ARTemporaryAPI: ios (high)
- ARTLiveAuctionView: ios (high)
- ARTNativeScreenPresenter: ios (high)
- ArtsyNative: android (high)
...
- ios/Artsy/NativeModules/ARCocoaConstantsModule.m
- ios/Artsy/NativeModules/ARNotificationsManager.m
- ios/Artsy/NativeModules/ARPHPhotoPickerModule.m
- ios/Artsy/NativeModules/ARScrollViewHelpers.mm
- ios/Artsy/NativeModules/ARTArtsyNativeModule.m
- ios/Artsy/NativeModules/ARTDeeplinkTimeoutModule.m
- ios/Artsy/NativeModules/ARTemporaryAPIModule.m
- ios/Artsy/NativeModules/ARTLiveAuctionViewManager.m
- ios/Artsy/NativeModules/ARTNativeScreenPresenterModule.m
- android/app/src/main/java/net/artsy/app/ArtsyNativeModule.java
- android/app/src/main/java/net/artsy/app/ArtsyNativePackage.java
...
## Task 12 — Authentication SDK Verification
...
- Detected packages: @react-native-firebase/messaging, @react-native-google-signin/google-signin, react-native-fbsdk-next.
...
- Detected packages: @react-native-documents/picker, react-native-image-crop-picker, react-native-linear-gradient, react-native-view-shot, react-native-webview.
...
- AsyncStorage: 14 file group(s).
- NetInfo: 4 file group(s).
- Clipboard: 10 file group(s).
...
- src/app/NativeModules/LegacyNativeModules.tsx
- src/app/store/AuthModel.ts
- src/app/store/persistence.ts
- src/app/utils/LocalImageStore.ts
- src/app/utils/PushNotification.ts
- src/app/Scenes/MyCollection/MyCollectionLegacy.tsx
- src/app/system/navigation/useReloadedDevNavigationState.ts
- src/app/store/__tests__/persistence.tests.ts
- src/app/system/relay/usePurgeCacheOnAppUpdate.ts
- src/app/utils/__tests__/PushNotification.tests.ts
- src/app/Scenes/MyCollection/Components/MyCollectionStickyHeader.tsx
- src/app/system/flags/Components/WrappedFlagProvider.tsx
- src/app/system/navigation/__tests__/useReloadedDevNavigationState.tests.tsx
- src/app/system/devTools/DevMenu/Components/DevTools.tsx
- src/app/utils/NetworkAwareProvider.tsx
- src/app/utils/volleyClient.ts
- src/app/Scenes/Inbox/Screens/Conversation.tsx
- src/app/Scenes/Inbox/Screens/__tests__/Conversation.tests.tsx
- src/app/utils/QAInfo.tsx
- src/app/utils/visualizer.ts
- src/app/Scenes/Collection/Collection.tsx
- src/app/Scenes/Fair/Fair.tsx
- src/app/Components/LocationMap/LocationMap.tsx
- src/app/Components/ShareSheet/ShareSheet.tsx
- src/app/Scenes/OrderHistory/OrderDetails/Components/WireTransferInfo.tsx
- src/app/system/devTools/DevMenu/Components/DevTools.tsx
- src/app/system/devTools/DevMenu/Components/ExperimentFlagItem.tsx
- src/app/system/devTools/DevMenu/Components/PushNotificationOptions.tsx
- src/app/system/ignoreLogs.ts
