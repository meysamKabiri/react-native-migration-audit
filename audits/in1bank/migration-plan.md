...
- UI / Native Visual Components (medium): @react-native-picker/picker, react-native-calendars, react-native-document-picker, react-native-image-crop-picker, react-native-vector-icons. Run visual smoke tests on screens using native UI components after each upgrade stage.
